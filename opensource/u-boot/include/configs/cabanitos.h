...
#if defined(CONFIG_TARGET_RPI_2) || defined(CONFIG_TARGET_CABANITOS)
...
#define ENV_MEM_LAYOUT_SETTINGS \
	...
	"bootargs=8250.nr_uarts=1 dma.dmachans=0x7f35 bcm2708_fb.fbwidth=720 " \
	"bcm2709.serial=0x5b9a8eec smsc95xx.macaddr=B8:27:EB:9A:8E:EC " \
	"bcm2708_fb.fbheight=480 bcm2709.boardrev=0xa02082 " \
	"bcm2708_fb.fbswap=1 bcm2709.uart_clock=48000000 vc " \
	"mem.mem_base=0x3dc00000 vc_mem.mem_size=0x3f000000 " \
	"console=ttyS0,115200 kgdboc=ttyS0,115200 console=tty1 " \
	"root=/dev/mmcblk0p2 rootfstype=ext4 rootwait\0" \
	"bootcmd=mmc dev 0;fatload mmc 0:1 ${kernel_addr_r} zImage;" \
